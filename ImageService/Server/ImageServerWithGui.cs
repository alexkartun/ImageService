...
{
    class ImageServerWithGui : IServer
    {
        ...
        private TcpServerChannelWithGui channel;

        public ImageServerWithGui(ILoggingService logger, IImageController controller)
        {
            channel = new TcpServerChannelWithGui();
